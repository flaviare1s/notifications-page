...
export function App() {
  ...
  return (
    <div className="font-Jakarta flex flex-col justify-center items-center m-auto w-full md:pt-[63px] md:pb-[89px] bg-very_light_grayish_blue">
      <div className="flex flex-col justify-center items-center m-auto w-full px-4 pt-6 pb-7 bg-white md:w-[70%] lg:w-[55%]">
